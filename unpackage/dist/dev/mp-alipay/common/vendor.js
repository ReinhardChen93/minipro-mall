...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": {}, "pages/cart/cart": { "pullRefresh": true }, "pages/my/my": {}, "pages/class/class": {}, "pages/search/search": {}, "pages/search-list/search-list": {}, "pages/detail/detail": {}, "pages/detail-comment/detail-comment": { "defaultTitle": "商品评价" }, "pages/user-set/user-set": { "defaultTitle": "用户设置" }, "pages/user-userinfo/user-userinfo": { "defaultTitle": "修改资料" }, "pages/user-path-list/user-path-list": { "defaultTitle": "收货地址" }, "pages/user-path-edit/user-path-edit": { "defaultTitle": "增加收货地址" }, "pages/order/order": { "defaultTitle": "我的订单" }, "pages/order-confirm/order-confirm": { "defaultTitle": "订单配送至", "titleBarColor": "#FD6801" }, "pages/order-invoice/order-invoice": { "defaultTitle": "发票" }, "pages/login/login": {}, "pages/msg-list/msg-list": { "defaultTitle": "消息列表" }, "pages/msg-detail/msg-detail": { "defaultTitle": "消息详情页" }, "pages/pay-methods/pay-methods": { "defaultTitle": "选择支付方式" }, "pages/pay-result/pay-result": { "defaultTitle": "支付成功" }, "pages/order-coupon/order-coupon": { "defaultTitle": "优惠券" }, "pages/order-detail/order-detail": { "titleBarColor": "#FD6801" }, "pages/logistics-detail/logistics-detail": { "defaultTitle": "物流信息" }, "pages/after-sale/after-sale": { "defaultTitle": "申请售后" }, "pages/about/about": { "defaultTitle": "关于我们" } }, "globalStyle": { "defaultTitle": "仿小米", "titleBarColor": "#FFFFFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;
